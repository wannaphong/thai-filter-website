...
with open("/ist/th_culturax_data_raw.jsonl","w",encoding="utf-8") as out:
    for t in tqdm(ds,total=20960550+1):
        ...
        #     continue
        ss = ujson.dumps({"meta": {"src":"uonlp/CulturaX",'source':t['source'],'url':t['url'],'timestamp':t['timestamp']}, "text": t['text']}, ensure_ascii=False)
        out.write(ss + "\n")